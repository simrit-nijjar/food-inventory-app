...
public class EditSecondActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        expET.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                picker = new DatePickerDialog(EditSecondActivity.this,
    ...
    private void moveToMainActivity() {
        Intent intent = new Intent(EditSecondActivity.this, com.griffins.whatsinmyfridge.activities.MainActivity.class);
