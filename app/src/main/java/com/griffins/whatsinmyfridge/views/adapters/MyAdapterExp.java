...
public class MyAdapterExp extends RecyclerView.Adapter<MyAdapterExp.MyViewHolder> {
    ...
    public MyAdapterExp(Context ct, ArrayList<Food> expired) {
        context = ct;
        // list = expired.toArray(new String[expired.size()]);
        list = expired;
    ...
    public MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = inflater.inflate(R.layout.my_row_exp, parent, false);
    ...
    public void onBindViewHolder(@NonNull MyViewHolder holder, final int position) {
        ...
        holder.mainLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent = intent.putExtra("myImage", images[position]);
